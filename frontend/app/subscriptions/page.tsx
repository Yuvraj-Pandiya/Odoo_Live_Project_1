      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px' }}>
          <div className="df-card" style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <span suppressHydrationWarning style={{ fontSize: '28px', fontWeight: 700, color: 'var(--text-primary)' }}>₹{totalARR.toLocaleString('en-IN')}</span>
          ...
          <div className="df-card" style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            ...
            <span suppressHydrationWarning style={{ fontSize: '28px', fontWeight: 700, color: 'var(--text-primary)' }}>₹{totalMRR.toLocaleString('en-IN')}</span>
            <span className="body-sm" suppressHydrationWarning>Avg. contract: ₹{(totalMRR / INITIAL_SUBSCRIPTIONS.length).toFixed(0)}/mo</span>
          </div>
          <div className="df-card" style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
                ...
                {paginatedData.length === 0 ? (
                  ...
                  paginatedData.map((sub) => (
                    <tr key={sub.id} style={{ borderBottom: '1px solid var(--border, #DCDCD9)' }}>
                      ...
                      <td suppressHydrationWarning style={{ padding: '14px 18px', textAlign: 'right', fontWeight: 700, color: '#15803D' }}>
                        ₹{sub.mrr.toLocaleString('en-IN')}/mo
                      </td>
                      <td suppressHydrationWarning style={{ padding: '14px 18px', textAlign: 'right', color: 'var(--text-primary)', fontWeight: 600 }}>
                        ₹{sub.arr.toLocaleString('en-IN')}/yr
                      </td>
